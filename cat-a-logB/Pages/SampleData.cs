...
namespace cat_a_logB.Pages
{
    public class SampleData
    {
        ...
        private static List<ProjectMilestone> milestones = new List<ProjectMilestone>
        {
            ...
            new ProjectMilestone { Name = "Milestone 1", Tasks = new List<TaskData>() {tasks[1],tasks[2] ,} , TargetDate = new DateTime(2023, 11, 26),   Color = "blue"},
            new ProjectMilestone { Name = "Milestone 2", Tasks = new List<TaskData>() {tasks[0],tasks[4] ,} ,TargetDate = new DateTime(2023, 11, 22), Color= "blue"},
